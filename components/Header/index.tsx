    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center  ${sticky
          ...
          : "absolute bg-transparent items-center "
          }`}
      >
        <div className="container">
          <div className="relative flex items-center justify-between">
            <div className="w-100 flex">
              ...
              >
                <h1 style={{ fontSize: "30px", fontFamily: 'Poppins', fontWeight: 800 }}>
                  mind
                </h1>
              </Link>
            </div>
            <div className="flex w-full items-center justify-between px-4">
                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                    {menuData.map((menuItem, index) => (
                      <li key={index} style={{ fontSize: "30px", fontFamily: 'Poppins', textTransform: "uppercase" }} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`flex font-semibold py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  ...
                  className="ease-in-up shadow-btn hover:shadow-btn-hover hidden rounded-sm bg-primary px-8 py-3 text-base font-semibold text-white transition duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Sign Up
                </Link>
                <div>
