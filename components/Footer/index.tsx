        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Mind is a dynamic learning center offering diverse courses providing an inclusive environment and innovative instruction to empower learners for success.
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Powered By
              <a href="https:/asuns.org" rel="nofollow noopener">
                {" "}Asuns.org
              </a>
            </p>
          </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2BAFFC" stopOpacity="0.62" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2BAFFC" stopOpacity="0" />
                <stop offset="1" stopColor="#2BAFFC" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
